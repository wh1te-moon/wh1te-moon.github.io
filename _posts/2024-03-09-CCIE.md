...
2. Controller Layer
   1. DNA center
      1. NCP network control platform
      2. NDP network data platform
   2. ISE identity service
3. Network Layer
   1. fabric overlay
      ...
      4. There are five roles for basic devices in the fabric overlay:
         1. control plane node:MS/MR,contain the settings and map EID-to-RLOC
         2. Fabric border node:connects external Layer 3 device to the SDA fabric
